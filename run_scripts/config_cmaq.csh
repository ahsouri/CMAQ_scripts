...
#> Critical Folder Locations
 ...
 setenv CMAQ_HOME /discover/nobackup/asouri/MODELS/CMAQv5.5/
...
#>  Intel fortran compiler......................................................
    case intel:
        ...
        setenv NETCDF /usr/local/other/wrfDeps/Intel-2021.4.0/  # Note please combine netCDF-C & Fortran Libraries 
        setenv IOAPI  /usr/local/other/wrfDeps/Intel-2021.4.0/
        setenv WRF_ARCH # [1-75]  
    
        #> I/O API, netCDF, and MPI Library Locations -- used in CMAQ
        setenv IOAPI_INCL_DIR   /usr/local/other/wrfDeps/Intel-2021.4.0/include/             #> I/O API include header files
        setenv IOAPI_LIB_DIR    /usr/local/other/wrfDeps/Intel-2021.4.0/lib/             #> I/O API libraries
        setenv NETCDF_LIB_DIR   /usr/local/other/wrfDeps/Intel-2021.4.0/lib/            #> netCDF C directory path
        setenv NETCDF_INCL_DIR  /usr/local/other/wrfDeps/Intel-2021.4.0/include/            #> netCDF C directory path
        setenv NETCDFF_LIB_DIR  /usr/local/other/wrfDeps/Intel-2021.4.0/lib/           #> netCDF Fortran directory path
        setenv NETCDFF_INCL_DIR /usr/local/other/wrfDeps/Intel-2021.4.0/include/           #> netCDF Fortran directory path
        setenv MPI_INCL_DIR     /usr/local/intel/oneapi/2021/mpi/2021.4.0/include/              #> MPI Include directory path
        setenv MPI_LIB_DIR      /usr/local/intel/oneapi/2021/mpi/2021.4.0/lib/               #> MPI Lib directory path
        ...
        setenv myFC mpif90
        setenv myCC mpicc    
        setenv myFSTD "-O2 -fno-alias -mp1 -fp-model source -ftz -simd -align all -msse4.2 -vec-guard-write" #"-O3 -fno-alias -mp1 -fp-model source -ftz -simd -align all -msse4.2 -vec-guard-write -unroll-aggressive"
