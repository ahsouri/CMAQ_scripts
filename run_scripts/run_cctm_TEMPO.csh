...
#> Set General Parameters for Configuring the Simulation
 ...
 set APPL      = CONUS_8km  #> Application Name (e.g. Gridname)
...
setenv GRID_NAME CONUS_8km          #> check GRIDDESC file for GRID_NAME options
setenv GRIDDESC $INPDIR/mcip/CONUS_8km/GRIDDESC    #> grid description file
...
set METpath   = $INPDIR/mcip/CONUS_8km/                #> meteorology input directory 
...
# =====================================================================
  ...
  if ($NEW_START == true || $NEW_START == TRUE ) then
     setenv ICFILE ICON_v55_2016_12SE1_profile_20230601
  ...
  set BCFILE = BCON_geoscf_cb6r3_ae7_CONUS_8km_${TODAYG}T00_25h.nc
  ...
  setenv GRID_BDY_2D $METpath/GRIDBDY2D_${APPL}_${YYYYMMDD}.nc  # GRID files are static, not day-specific
  setenv GRID_CRO_2D $METpath/GRIDCRO2D_${APPL}_${YYYYMMDD}.nc
  setenv GRID_CRO_3D $METpath/GRIDCRO3D_${APPL}_${YYYYMMDD}.nc
  setenv GRID_DOT_2D $METpath/GRIDDOT2D_${APPL}_${YYYYMMDD}.nc
  setenv MET_CRO_2D $METpath/METCRO2D_${APPL}_${YYYYMMDD}.nc
  setenv MET_CRO_3D $METpath/METCRO3D_${APPL}_${YYYYMMDD}.nc
  setenv MET_DOT_3D $METpath/METDOT3D_${APPL}_${YYYYMMDD}.nc
  setenv MET_BDY_3D $METpath/METBDY3D_${APPL}_${YYYYMMDD}.nc
  setenv LUFRAC_CRO $METpath/LUFRAC_CRO_${APPL}_${YYYYMMDD}.nc
  ...
  setenv CMAQ_MASKS $SZpath/OCEAN_${MM}_L3m_MC_CHL_chlor_a_CONUS_8km.nc #> horizontal grid-dependent ocean file
  #setenv CMAQ_MASKS $INPDIR/GRIDMASK_STATES_12NE3.nc

  #> Gridded Emissions Files 
  setenv N_EMIS_GR 2

  set EMISfile  = FINNv1.5_2016.CB6r3.NRT.CONUS_8km.3D.${TODAYG}.nc #FINNv1.5_2016.CB6r3.NRT.CONUS_8km.3D.${START_DATE}.nc
  ...
  #> In-line lightning NOx options
     ...
     setenv LTNGPARMS_FILE ${IN_LTpath}/LTNG_AllParms_CONUS_8km.ncf #> lightning parameter file
  endif
  ...
  if ( $CTM_BIOGEMIS_BE == 'Y' ) then
     ...
     setenv BEIS_NORM_EMIS $IN_BEISpath/beis_norm_emis_CONUS_8km_2020ha2_cb6_20k.ncf
  ...
  setenv OCEAN_1 $SZpath/OCEAN_${MM}_L3m_MC_CHL_chlor_a_CONUS_8km.nc #> horizontal grid-dependent ocean file
...
#       setenv PA_BLEV_ELEV "1  4"   # default: all levels
        setenv PACM_INFILE ./pa_input.txt
